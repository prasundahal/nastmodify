...
$result = mysql_query("SELECT * FROM fung where status='0' ORDER BY id DESC");
?>
...
<a href="nes.php">Add New Data</a><br/><br/>
	...
	($res = mysql_fetch_array($result)) { 
		...
		echo "<td><a href=\"viewdetail.php?id=$res[id]\">View</a> | <a href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
</body>
