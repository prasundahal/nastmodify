...
$weight = $groups -> getLastWeight("PackageType", 0);
...
if($_POST['type'] == "Save")
{
	...
	if(empty($errMsg)){
		...
		if($id > 0)
			...
			$msg = "Package Type saved successfully";
		header("Location: packagetype.php?parentId=$parentId&msg=$msg");
		exit();
	}
}
if($_GET['type']=="del")
{
	...
	{
		$groups -> delete($id);
		header("Location: packagetype.php?parentId=$parentId&msg=Package Type deleted successfully");
		exit();
	}
}
?>
                  ...
                  <td bgcolor="#fff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="heading2">&nbsp;Manage Package Type / Category
                          <div style="float: right;"> <a href="packagetype.php" class="headLink"> Add New </a> </div></td>
                      </tr>
                      <tr>
                        <td><table width="100%" border="0" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <select name="parentId" class="list1">
                                ...
                                <?php
                                $groups->comboRecursionTravel("PackageType", $parentId, 0);
                                ?>
                              </select>
                              </td>
                            </tr>
          ...
          <td class="bgborder"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="heading2">&nbsp;Package Type / Category List</td>
                    </tr>
                    <tr>
                      <td><table width="100%"  border="0" cellpadding="4" cellspacing="0">
                          ...
                          <tr <?php if($counter%2 != 0) echo 'bgcolor="#F7F7F7"'; else echo 'bgcolor="#FFFFFF"'; ?>>
                            ...
                            <td valign="top">
                            	[<a href="packagetype.php?parentId=<?= $row['id']?>">Open</a>]
                              [<a href="packagetype.php?type=edit&id=<?= $row['id']?>">Edit</a>]
                              <? if($groups -> isDeletable($row['id'])) { ?>
                              [<a href="#" onClick="javascript: if(confirm('This will permanently remove this Region from database. Continue?')){ document.location='packagetype.php?type=del&parentId=<?php echo $row['parentId']; ?>&id=<?php echo $row['id']; ?>'; }">Delete</a>]
                              <? } ?>
                            </td>
                          </tr>
                          <?
