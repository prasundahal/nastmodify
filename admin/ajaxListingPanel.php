...
<div>
  ...
  <input type="text" name="listTitle" id="listTitle" value="<?php echo $listRow['name']; ?>" class="text" onchange="copySame('listUrlTitle', this.value);" /></span>
	<br class="clearboth" />
	<span style="padding-right:25px;">Alias Title : </span> <span>
  <input type="text" name="listUrlTitle" id="listUrlTitle" value="<?php echo $listRow['urlname']; ?>" class="text" onchange="copySame('listUrlTitle', this.value);" />
  </span> <br class="clearboth" />
  <div>Short Description : </div> <span>
  <textarea name="listShortDescription" rows="7" cols="110"><?php echo $listRow['shortcontents']; ?></textarea>
  </span> <br class="clearboth" />
